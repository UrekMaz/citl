...
function InvestorCard({ name, affiliation, notableInvestments, background, imageUrl, initialFavorite }) {
  // Manage the isFavorite state inside the component
  ...
  return (
    <article className="flex flex-wrap gap-6 items-start mt-10 w-full bg-neutral-100 max-md:max-w-full rounded-lg border border-gray-200 transition-transform duration-300 ease-in-out hover:scale-105 hover:shadow-lg">
